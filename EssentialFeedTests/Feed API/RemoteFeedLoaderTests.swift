...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    private func makeSUT(url: URL = URL(string: "http://a-url.com")!, file: StaticString = #file, line: UInt = #line) ->
    ...
    private func expect(_ sut: RemoteFeedLoader,
        ...
        sut.load() { receivedResult in
            ...
            default:
                XCTFail("Expected result was \(expectedResult) but got \(receivedResult) instead")
            }
